 ...
 */
public class DprMSDFErrorCorrection {
    ...
    //TODO 20251225 uhoh. might have trailing issues here too.
    // also, Java byte is not 100% the same as C++ byte, C++ byte is range 0 to 255, Java is -128 to 127.
    public DprMSDFErrorCorrection(DprBitmapRef stencil, SDFTransformation transformation) {
